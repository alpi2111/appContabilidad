 ...
 * @author Zaleta
 */
public class Interfaz_Costos4 extends javax.swing.JInternalFrame {

    DefaultTableModel Modelo1 = new DefaultTableModel();

    public Interfaz_Costos4() {
        initComponents();
        try {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Costos. Costos Mensuales Variables");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        CDato3.setText(null);
        CDato4.setText(null);// TODO add your handling code here:
    ...
    private void Tabla1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tabla1MouseClicked
        int Fila = Tabla1.getSelectedRow();
        if (Fila >= 0) {
            CDato3.setText(Tabla1.getValueAt(Tabla1.getSelectedRow(), 0).toString());
            CDato4.setText(Tabla1.getValueAt(Tabla1.getSelectedRow(), 1).toString());
        } else {
