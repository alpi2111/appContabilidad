...
public class Interfaz_Ingresos1 extends javax.swing.JInternalFrame {
    ...
    private Object calcular() {
        ...
        Año4 = Año3 * 1.05;
        Año5 = Año4 * 1.05;
        return new Object[]{Datos[0], Semanal, Meses, Mensual, Año0, Año1, Año2, Año3, Año4, Año5};
    }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        CIngreso1.setText(null);
        CIngreso2.setText(null);
        CIngreso3.setText(null);
        CIngreso1.requestFocus();
    ...
    private void Tabla1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tabla1MouseClicked
        ...
        int Fila = Tabla1.getSelectedRow();
        if (Fila >= 0) {
            CIngreso1.setText(Tabla1.getValueAt(Tabla1.getSelectedRow(), 0).toString());
            CIngreso2.setText(Tabla1.getValueAt(Tabla1.getSelectedRow(), 1).toString());
            CIngreso3.setText(Tabla1.getValueAt(Tabla1.getSelectedRow(), 2).toString());
        } else {
