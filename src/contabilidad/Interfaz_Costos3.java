 ...
 * @author Zaleta
 */
public class Interfaz_Costos3 extends javax.swing.JInternalFrame {

    DefaultTableModel Modelo1 = new DefaultTableModel();

    public Interfaz_Costos3() {
        initComponents();
        try {
    ...
    private Object calcular() {
        ...
        return new Object[]{Datos[0], Año1, Año2, Año3, Año4, Año5};
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Costos. Cálculo de Costos Variables");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        CDato1.setText(null);
        CDato2.setText(null);      // TODO add your handling code here:
    ...
    private void Tabla1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tabla1MouseClicked
        int Fila = Tabla1.getSelectedRow();
        if (Fila >= 0) {
            CDato1.setText(Tabla1.getValueAt(Tabla1.getSelectedRow(), 0).toString());
            CDato2.setText(Tabla1.getValueAt(Tabla1.getSelectedRow(), 1).toString());
        } else {
